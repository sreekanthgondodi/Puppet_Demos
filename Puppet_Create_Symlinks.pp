# ***********************************************  Scenario: Puppet Create Symlinks  ***********************************************
...
# Create a blank file blog.txt under /opt/itadmin directory on all puppet agent nodes i.e on all App Servers.
...
# vi /etc/puppetlabs/code/environments/production/manifests/games.pp
